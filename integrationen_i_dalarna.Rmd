...
I diagrammet ovan framgår också att det finns avsevärda skillnader mellan länen. `r arblosthet_utrikes_man_min_lan ` hade den lägsta arbetslösheten för såväl utrikes födda män som kvinnor i  `r arbetsloshesstatus_manad` `r arbetsloshesstatus_ar`  med `r arblosthet_utrikes_man_min_varde` respektive `r arblosthet_utrikes_kvinna_min_varde` procent.

Högst arbetslöshet för såväl utrikes födda män som kvinnor hade `r arblosthet_utrikes_man_max_lan` med `r arblosthet_utrikes_man_max_varde` procent för män och `r arblosthet_utrikes_kvinna_max_varde` procent för kvinnor. Dalarna ligger något över riksgenomsnittet, men uppvisar inte extrema arbetslöshetssiffror åt något håll.

Även bland länets kommuner var variationen i arbetslöshet stor i `r arbetsloshesstatus_manad` `r arbetsloshesstatus_ar` . Bland inrikes födda var arbetslösheten något högre för män än för kvinnor, men generellt låg i samtliga Dalarnas kommuner. Högst arbetslöshet för inrikes födda män i Dalarna finns i `r arblosthet_inrikes_man_max_kommun`, men skillnaden gentemot genomsnittet i länet är relativt liten.

Högst arbetslöshet för inrikes födda kvinnor fanns i `r arblosthet_inrikes_kvinna_max_kommun`.
