...
```
<span class = "kommentar">Tror att vi kan ta bort ovanstående diagram samt stycket innan. Alternativet är att utöka tidsserien, men då liknar diagrammet linjediagrammet ovan.</span>
<br>
...
Vid norm 2 sätts gränsen för trångboddhet vid högst två personer per rum, exklusive kök och vardagsrum.

Ytterligare en relevant analys rörande boende är andelen trångbodda hushåll. Trångboddhet i lägenheter i flerbostadshus mäts av SCB enligt Norm 2 ([Boverket](https://www.boverket.se/sv/kommunernas-bostadsforsorjning/underlag-for-bostadsforsorjningen/sarskilda-grupper/trangbodda/){target="_blank"}), vilket innebär att gränsen för trångboddhet går vid högst två personer per rum, exklusive kök och vardagsrum.
...
<span class = "kommentar">Förslag att vi stryker resterande delar kring boende, d v s kommunperspektivet samt boendeytor per person </span>
...
Sedan slutet av 1990-talet har Dalarna haft ett negativt inrikes flyttnetto under en överväldigande majoritet av åren.  I Dalarna är det framförallt unga personer som flyttar, vilket kan förklaras med att de flyttar för att studera och arbeta. Flyttar från Dalarna inrikes sker i första hand till antingen större eller näraliggande län. Flest flyttar skedde till Stockholm, följt av Västmanland och Uppsala (se *Befolkningsutvecklingen i Dalarna - länka*). Effekten av att unga flyttar från länet blir en allt mer ålderstigen befolkning.

<span class = "kommentar"> Hämta in diagram från Befolkningsutvecklingen i Dalarna i 3.1 - Inrikes flyttningsöverskott Dalarna </span>
...
*Hur ser det ut med omflyttningar generellt bland utrikes födda de senaste 10 åren? Hur länge stannar de som flyttar in? Kommer de som flyttar att komma tillbaka?*

<span class = "kommentar"> Hämta in diagram från Befolkningsutvecklingen i Dalarna i 3.5 - Inrikes flyttnetto i Dalarna </span>

<span class = "kommentar"> Lägga till något om utrikes flyttningar och invandringsöverskottet </span>
...
<span class = "kommentar"> Gammal text nedan </span>

Det kan konstateras att flyttströmmarna har varit stora både till och från länet, både för utrikes och inrikes födda. Båda grupperna flyttar dock i större utsträckning från Dalarna till övriga Sverige än till Dalarna från övriga Sverige. Utrikes födda personer har generellt sett varit mer benägna att flytta från länet än inrikes födda varit.


# Hälsa, ekonomi, tillit och demokrati
Utöver områden som språk, utbildning och arbete följer ett antal ytterligare områden som är viktiga för integrationen i samhället. Att ha en god hälsa, ekonomiska förutsättningar att utvecklas, samt tillit till samhället och demokratiskt engagemang är samtliga komponenter som behöver värderas ur ett integrationsperspektiv.

## Hälsa
Hälsa mäts normalt via Folkhälsomyndigheten i form av den nationella folkhälsoenkäten - Hälsa på lika villkor. 
...
Utrikes födda från Övriga Europa och Övriga världen uppger att de har en bättre hälsa än inrikes födda. Den grupp som har lägst självskattad hälsa är gruppen Övriga Norden har lägre nivåer än övriga. Det är sannolikt kopplade till en hög andel personer som invandrat från Finland, vilket är en ålderstigen grupp i samhället. Det kan noteras i avsnitt 1 att den gruppen också minskar i antal.
