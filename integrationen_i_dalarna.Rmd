...
<span class = "kommentar">Det här avsnittet borde eventuellt flyttas upp ett steg, så att det följer direkt på diskussionen runt befolkningsutveckling</span>
...
<span class = "kommentar">Stycke och figur nedan borde eventuellt flyttas så att det hamnar direkt efter det andra diagrammet på kommunnivå ovan.</span>
...
<span class = "kommentar"> Flytta figurer kopplade till utbildning hit? Just nu ligger många av dessa efter arbetsmarknadsavsnittet</span>
