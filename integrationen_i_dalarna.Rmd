...
Befolkningen i arbetsför ålder (`r unique(antal_forandring_lan_kumulativ$alder_grupper)`) är särskilt intressant att fokusera på då den bidrar till att balansera en allt äldre befolkning och förbättrar möjligheten att kompetensförsörja näringsliv och offentlig sektor i framtiden.
...
Den demografiska översikten visar att andelen utrikes födda i Dalarna ökat över tid och bidragit till att föryngra och vidmakthålla länets invånarantal. I nästa avsnitt fokuseras på integrationen i form av språk, utbildning, inträde och etablering på arbetsmarknaden.
...
Hur långt ifrån arbetsmarknaden som en individ befinner sig beror delvis på hur länge personen har varit utan anställning. En person som har varit arbetslös länge har ofta svårare att ta sig tillbaka in på arbetsmarknaden. Bland arbetslösa inrikes födda i åldersgruppen `r arbesloshetstid_aldersgrupp` har ungefär `r arbetsloshetstid_inrikes_24_manader` procent varit arbetslösa länge (minst 24 månader) och får anses stå långt från arbetsmarknaden. Sammanlagt har ungefär `r arbetsloshetstid_inrikes_minst_12_manader` procent av arbetslösa inrikes födda varit det i minst 12 månader. Bland inrikes födda arbetslösa är det istället de som har varit arbetslösa under en relativt kort period (< 6 månader) som är den störstsa gruppen (ca `r arbetsloshetstid_inrikes_6_manader` av alla inrikes födda arbetslösa).

Bland utrikes födda är bilden delvis annorlunda. Här är den största gruppen arbetslösa de som varit arbetslösa väldigt länge (längre än 24 månader), totalt tillhör `r arbetsloshetstid_utrikes_24_manader` procent av de arbetslösa utrikes födda i åldersgruppen `r arbesloshetstid_aldersgrupp` den gruppen. Sammanlagt har mer än `r arbetsloshetstid_utrikes_minst_12_manader` procent av de arbetslösa utrikes födda varit det i minst 12 månader. 
...
Fördelningen är relativt jämn mellan kvinnor och män. Bland inrikes födda har något större andel kvinnor än män varit arbetslösa länge (mer än 24 månader), medan något större andel män än kvinnor varit arbetslösa under en kort period. För utrikes födda har ungefär lika stor andel kvinnor som män varit arbetslösa i minst 24 månader.
...
<span class = "kommentar">Kort sammanfattning av ett långt avsnitt?</span>
...
I denna rapport har integrationen av utrikes födda analyserats utifrån demografi, utbildning, arbetsmarknad, boende, flyttmönster, hälsa, ekonomi, tillit och demokrati. Trots den breda genomgången inom ett flertal, för integrationen, viktiga områden gör rapporten inte anspråk på att vara heltäckande. 
...
Det är dock tydligt att invandringen till Dalarna fört med sig ett antal 

Dalarnas inrikes födda befolkning har under de senaste decennierna minskat i antal och fått en förändrad åldersstruktur. Färre i arbetsför ålder ska försörja fler som inte arbetar. Befolkningstillskottet från utrikes födda har bidragit till att begränsa denna negativa demografiska utveckling, dels i antal invånare, dels i en ökad andel i arbetsför ålder och föryngring av befolkningen. Den aktuella invandringsnivån, i kombination med låga födelsetal, leder till en allt mer åldrad befolkning och utmanar kompetensförsörjningen framöver.

<span class = "kommentar"> Plocka upp de positiva trenderna som finns </span>

Trots den positiva utveckling som kan ses inom ett flertal områden i rapporten, är det fortfarande en generell skillnad mellan inrikes och utrikes födda, även när vistelsetiden i Sverige tas i beaktande.

Andelen utrikes födda med behörighet till gymnasiet är lägre. Även andelen som är behöriga till högskola är lägre, men inte i samma utsträckning som i fallet med gymnasiebehörighet. Utbildningsnivån är generellt lägre och arbetslösheten högre, även långtidsarbetslösheten. Det finns en högre andel hushåll med utrikes födda som är trångbodda, fler personer finns i hushåll med låg ekonomisk standard och högre andelar har behov av ekonomiskt stöd eller saknar inkomster. I de flesta fall är ovanstående observationer giltiga för såväl män som kvinnor.

Det finns med andra ord mer att göra när det kommer till att utnyttja den resurs som utrikes födda är, särskilt på arbetsmarknaden nu och i framtiden. Att säkerställa kunskap i svenska och att lyfta utbildningsnivån för utrikes födda är avgörande för att se en ökad etablering på arbetsmarknaden. Det minskar även behovet av introduktion och utbildning på arbetsplatsen från den inrikes födda arbetskraften i en tid där det finns stora utmaningar med kompetensförsörjningen på arbetsmarknaden.
