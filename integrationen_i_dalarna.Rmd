...
Enligt *SCB:s* befolkningsprognos förväntas antalet utrikes födda i Dalarnas län mellan 16–64 år att öka med `r kumulativ_summa_utrikes_max_prognos` personer mellan `r min_ar_utrikes_kumulativ_prognos` och `r max_ar_utrikes_kumulativ_prognos`, medan antalet inrikes födda personer i länet förväntas att minska med `r kumulativ_summa_inrikes_max_prognos` personer, enligt prognosen. Antalet personer mellan 16 och 64 år kommer således att minska i Dalarna fram till `r max_ar_utrikes_kumulativ_prognos` , vilket kan bli problematiskt för länets kompetensförsörjning.
