...
Diagrammet nedan visar att utvecklingen för inrikes födda är relativt opåverkad fram till 2013, men från 2014 (syns inte i diagrammet nedan) faller andelen behöriga markant. Minskningen är som störst för män, nästan `r skillnad_2013_senaste_man` procentenheter mellan 2013 och `r ar_max`. År `r ar_max` var andelen högskolebehöriga inrikes födda män ungefär `r inrikes_behorighet_hog_ar_max_man` procent. Andelen högskolebehöriga inrikes födda kvinnor har också minskat under perioden, men inte i samma utsträckning. `r ar_max` är cirka `r inrikes_behorighet_hog_ar_max_kvinnor` procent behöriga.
