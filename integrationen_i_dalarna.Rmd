...
Bland inrikes födda är valdeltagandet i val till Riksdagen relativt högt (närmare 90 procent) och har inte förändrats nämnvärt mellan de senaste valen. Utrikes födda har generellt ett lägre valdeltagande och i den gruppen har också valdeltagande minskat på senare år. 
