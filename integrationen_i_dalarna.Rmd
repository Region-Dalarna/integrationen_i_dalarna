...
*Vad behövs här för att introducera en utvidgad beskrivning av invandringen över tid?*
...
(<span class = "kommentar">Kollat hit 20250408</span>)

# Vägen till arbete

(<span class = "kommentar">Försöka besvara frågorna:
...
*Långtidsarbetslöshet för inrikes och utrikes födda*</span>)
