diagram_utbildningsniva_invandringsar <-function(output_mapp_figur = "G:/Samhällsanalys/Statistik/Näringsliv/basfakta/", # Outputmapp för figur
  ...
  input_mapp <- here("Indata") # Mapp med asylsökande data
